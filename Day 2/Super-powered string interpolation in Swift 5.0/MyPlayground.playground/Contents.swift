...
print("You should follow me on Twitter: \(twitter: "CubexsOne")")
...
extension String.StringInterpolation {
    mutating func appendInterpolation(_ person: Person) {
        appendLiteral("I'm a \(person.type) and I'm gonna \(person.type)")
    }
...
let hater = Person(type: "hate", action: "hate")
